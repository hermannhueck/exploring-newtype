...
object Ex07NewType extends hutil.App {

  object UserId {

    @newtype final case class Opaque(value: Int)

    // trait Tag            // generated by @newtype macro
    // type Base   = Any {
    //   type Hack
    // }
    ...
    object Opaque {
      ...
      // def apply(value: Int): Opaque =            // generated by @newtype macro
    ...
    // implicit final class Ops(private val userId: Opaque) extends AnyVal {            // generated by @newtype macro
  ...
  object ProjectId {
    ...
    // implicit final class Ops(private val projectId: Opaque) extends AnyVal {            // generated by @newtype macro
